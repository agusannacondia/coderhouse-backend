...
const getProducts = async () => await products.getProducts();

const getProduct = async (args) => await products.getProducts(args.id);

const addProduct = async (args) => await products.addProduct(args);
