 ...
 *
 *  To use a custom storage system, you should use -db param with the name of the storage system.
 *  In this case, mongoose is the only storage system available.
 *
 */

const args = minimist(process.argv.slice(2));
const STORAGE_SYSTEM = args["db"] || "mongoose";
...
switch (config.node_env) {
    case "production":
        console.log("You're running on production mode");
        break;
    case "development":
    default:
